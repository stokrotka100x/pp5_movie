...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'\\src\\Graucho\\MoviesBundle\\Resources\\config\\doctrine') => 'Graucho\\MoviesBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'Graucho\\MoviesBundle\\Entity');
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\XmlDriver(new \Doctrine\Common\Persistence\Mapping\Driver\SymfonyFileLocator(array(($this->targetDirs[3].'\\src\\FOS\\UserBundle\\Resources\\config\\doctrine\\model') => 'FOS\\UserBundle\\Model'), '.orm.xml')), 'FOS\\UserBundle\\Model');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('GrauchoMoviesBundle' => 'Graucho\\MoviesBundle\\Entity'));
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Graucho\\MoviesBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Graucho\\MoviesBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Graucho\\MoviesBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Graucho\\MoviesBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Graucho\\MoviesBundle\\Entity\\User');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h->setOptions(array('always_use_default_target_path' => false, 'default_target_path' => '/GMS/', 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username'), 1 => $this->get('security.user.provider.concrete.in_memory')), 'main', $b, $c), 2 => $g, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $f, $this->get('security.authentication.session_strategy'), $d, 'main', $h, $i, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, $this->get('form.csrf_provider')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '54ec4b0d9bcd6', $b, $f), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '/login', false), NULL, NULL, $b));
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Graucho\\MoviesBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.ar.yml'), 'ar', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.bg.yml'), 'bg', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.ca.yml'), 'ca', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.cs.yml'), 'cs', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.da.yml'), 'da', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.de.yml'), 'de', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.el.yml'), 'el', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.en.yml'), 'en', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.es.yml'), 'es', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.et.yml'), 'et', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.eu.yml'), 'eu', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.fa.yml'), 'fa', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.fi.yml'), 'fi', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.fr.yml'), 'fr', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.he.yml'), 'he', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.hr.yml'), 'hr', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.hu.yml'), 'hu', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.id.yml'), 'id', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.it.yml'), 'it', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.ja.yml'), 'ja', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.lb.yml'), 'lb', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.lt.yml'), 'lt', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.lv.yml'), 'lv', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.nb.yml'), 'nb', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.nl.yml'), 'nl', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.pl.yml'), 'pl', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.pt.yml'), 'pt', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.pt_BR.yml'), 'pt_BR', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.ro.yml'), 'ro', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.ru.yml'), 'ru', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.sk.yml'), 'sk', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.sl.yml'), 'sl', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.sr_Latn.yml'), 'sr_Latn', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.sv.yml'), 'sv', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.th.yml'), 'th', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.tr.yml'), 'tr', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.uk.yml'), 'uk', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.vi.yml'), 'vi', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.zh_CN.yml'), 'zh_CN', 'FOSUserBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.ar.yml'), 'ar', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.bg.yml'), 'bg', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.ca.yml'), 'ca', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.cs.yml'), 'cs', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.da.yml'), 'da', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.de.yml'), 'de', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.el.yml'), 'el', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.en.yml'), 'en', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.es.yml'), 'es', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.eu.yml'), 'eu', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.fa.yml'), 'fa', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.fi.yml'), 'fi', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.fr.yml'), 'fr', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.he.yml'), 'he', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.hr.yml'), 'hr', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.hu.yml'), 'hu', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.id.yml'), 'id', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.it.yml'), 'it', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.ja.yml'), 'ja', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.lt.yml'), 'lt', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.lv.yml'), 'lv', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.nb.yml'), 'nb', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.nl.yml'), 'nl', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.pl.yml'), 'pl', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.pt.yml'), 'pt', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.pt_BR.yml'), 'pt_BR', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.ro.yml'), 'ro', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.ru.yml'), 'ru', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.sk.yml'), 'sk', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.sl.yml'), 'sl', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.sr_Latn.yml'), 'sr_Latn', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.sv.yml'), 'sv', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.th.yml'), 'th', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.tr.yml'), 'tr', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.uk.yml'), 'uk', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.vi.yml'), 'vi', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/translations\\validators.zh_CN.yml'), 'zh_CN', 'validators');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Graucho\\MoviesBundle/Resources/views'), 'GrauchoMovies');
        $instance->addPath(($this->targetDirs[3].'\\src\\FOS\\UserBundle/Resources/views'), 'FOSUser');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml'), 1 => ($this->targetDirs[3].'\\src\\FOS\\UserBundle\\Resources\\config\\validation.xml')));
        ...
        $instance->addXmlMapping(($this->targetDirs[3].'\\src\\FOS\\UserBundle\\DependencyInjection\\Compiler/../../Resources/config/validation/orm.xml'));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'GrauchoMoviesBundle' => 'Graucho\\MoviesBundle\\GrauchoMoviesBundle',
            ...
            'fos_user.model.user.class' => 'Graucho\\MoviesBundle\\Entity\\User',
